...
public class IdentifierLexer extends Lexer {
	...
	public static final int
		FUNCTION_NAME=1, TYPE_NAME=2, VARIABLE_NAME=3;
	...
	public static final String[] ruleNames = {
		"FUNCTION_NAME", "TYPE_NAME", "VARIABLE_NAME"
	};

	private static final String[] _LITERAL_NAMES = {
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, "FUNCTION_NAME", "TYPE_NAME", "VARIABLE_NAME"
	};
	...
	public static final String _serializedATN =
		...
		"\2\2\t\n\3\2\2\2\n\4\3\2\2\2\13\f\3\2\2\2\f\6\3\2\2\2\r\16\3\2\2\2\16"+
		"\b\3\2\2\2\3\2\2";
